...
class RecordService {
    ...
    deleteRecord(recordId) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this.recordRepository.deleteRecord(recordId);
        });
    }
    updateRecord(record) {
        return __awaiter(this, void 0, void 0, function* () {
    ...
    deleteRecordById(recordId, user) {
        return __awaiter(this, void 0, void 0, function* () {
            const recordToDelete = yield this.recordRepository.getRecordById(recordId);
            if ((yield recordToDelete.userId) !== user.id) {
                throw new __index_1.RecordDoesNotExist();
            }
