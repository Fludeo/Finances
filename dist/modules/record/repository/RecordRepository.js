...
class RecordRepository {
    ...
    addRecord(newRecord, user) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const userToAdd = yield module_1.UserModel.findByPk(user.id);
            yield record.setUser(userToAdd);
        });
    }
    deleteRecord(recordId) {
        return __awaiter(this, void 0, void 0, function* () {
            yield this.recordModel.destroy({ where: { recordId } });
        });
    }
    updateRecord(record) {
        return __awaiter(this, void 0, void 0, function* () {
    ...
    deleteRecordById(recordId) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this.recordModel.destroy({ where: { id: recordId } });
        });
    }
    getAll(user) {
        return __awaiter(this, void 0, void 0, function* () {
