...
function addRecordDefinitions(container) {
    container.add({
        ...
        RecordRepository: (0, rsdi_1.object)(module_1.RecordRepository).construct((0, rsdi_1.use)(module_1.RecordModel)),
...
function addUserDefinitions(container) {
    container.add({
        ...
        UserRepository: (0, rsdi_1.object)(module_2.UserRepository).construct((0, rsdi_1.use)(module_2.UserModel)),
